...
Project Step 5 
Citation: Use starter code from https://canvas.oregonstate.edu/courses/2017561/pages/exploration-pl-slash-sql-quick-start-guide?module_item_id=25842917 to create SP.
*/
DROP PROCEDURE IF EXISTS sp_LoadStreamCloud;
DELIMITER //

CREATE PROCEDURE sp_LoadStreamCloud()
BEGIN
