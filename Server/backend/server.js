/*
Server by Brandon Vang and Jonathan Davis
Group 86 - Stream Cloud
12/5/2025
-- Citation for Server file based on template provided here: https://canvas.oregonstate.edu/courses/2017561/pages/exploration-web-application-technology-2?module_item_id=25645131 --
...
app.get("/albums", async (req, res) => {
  try {
    const query = `SELECT albums.albumID, albums.albumTitle, albums.releaseDate, albums.genre, albums.artistID, artists.artistName FROM albums 
